	...
	<div class="container">
		<div class="row banner-text">
			...
			<div class="col-lg-6 col-md-8 mt-lg-0 mt-sm-5 mt-3 banner-image text-lg-center">
					...
					<H6>Enviar para:</H6> <br>
					<table class='table table-striped'>
						<tr><th>Nome</th><th>Banco</th><th>Conta</th><th>Valor</th></tr>
						<tr>
							<?php $resp = mysqli_query($link,"SELECT * FROM match_cash ORDER BY id");  ?>
							<?php 
								while($dado=$resp->fetch_array()){ 
									if($dado['id']==1){
										echo "<td>".$dado['nome']."</td><td>".$dado['banco']."</td><td>".$dado['agencia']."</td><td>".$dado['valor']."</td><td>";
									}
								} 	
					...
					<table class='table table-striped'>
						...
						<tr>
							...
							<?php 
								while($dado=$resp->fetch_array()){ 
									if($dado['id']==2){
										echo "<td>".$dado['nome']."</td><td>".$dado['cpf']."</td><td>".$dado['valor']."</td>";
									}
								} 	
