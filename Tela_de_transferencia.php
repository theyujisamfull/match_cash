	...
	<div class="container">
		...
		<nav class="d-lg-flex">
			...
			<ul class="menu mt-2 ml-auto">
				...
				<li class="">
				<li class=""><a href="#popup5">Conciliação</a></li>
			</ul>
		...
		?>
				...
				<a class="user" href="#popup3"><?php echo $usuario; ?></a>
			</div>
		</nav>
		<div class="clear"></div>
		<!-- //nav -->
		...
		<div class="row banner-text">
			...
			<form  method="post" action='Match_Cash_Cadastro_enviar.php'>
				<div class="form-group">
					...
					<input type="text" class="form-control" name='email_receber' placeholder="" required="" value='bianca_martilio@gmail.com'>
				</div>
				<div class="form-group">
					<label>Valor</label>
					<input type="text" class="form-control" name='valor_a_transferir' placeholder="" required="" value='100'>
				</div>
		...
		<div class="login px-sm-4 mx-auto mw-100">
			...
			<form action="Match_Cash_entrar.php" method="post">
				<div class="form-group">
					...
					<input type="nome_usuario" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" required="">
